...
It sure seems that way, at least sometimes. But what if it's possible to do it the opposite way - Where IPv6 is the new default, end to end, and where IPv4 is the oddity, the exception, the old address space you’ll translate _to_ when needed? 
